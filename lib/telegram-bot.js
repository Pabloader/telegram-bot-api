...
var TelegramApi = function (params)
{
    ...
    function internalGetUpdates()
    {
        ...
        .then(function (data)
        {
            ...
            else
            {
                ...
                ('forEach' in data) && data.forEach(internalParseUpdate);
            }
     ...
     * Parse update object
     */
	function internalParseUpdate (item) {
	...
	this.processUpdate = internalParseUpdate;

	/** Express endpoint **/
	this.webhookEndpoint = function(req, res) {
		if (typeof(req.body) == 'object') {
			internalParseUpdate(req.body);
		} else {
